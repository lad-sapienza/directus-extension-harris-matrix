...
export default {
  ...
  setup(props, { emit }) {
    ...
    var contextLabelField = getSessionQueryField(
      "contextLabelField",
      "context_id"
    );
    var contentDescriptionField = getSessionQueryField(
      "contentDescriptionField",
      "description"
    );
    var contextTypeField = getSessionQueryField(
      "contextTypeField",
      "context_type"
    );
...
structure$shape=box;style=filled;fillcolor=#ebebeb;tooltip=Structure`;
    ...
    function queryFieldsChanged(
      ...
      sessionStorage.setItem(
        `${collection}_contextIdField_store`,
        contextIdField
      );
      sessionStorage.setItem(
        `${collection}_contextLabelField_store`,
        contextLabelField
      );
      sessionStorage.setItem(
        `${collection}_contentDescriptionField_store`,
        contentDescriptionField
      );
      sessionStorage.setItem(
        `${collection}_contextTypeField_store`,
        contextTypeField
      );
      getItems();
    }
